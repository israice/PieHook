...
import { check_closed_SHORT_GREEN_1 } from './BBAA_check_closed_SHORT_GREEN_1.js';
...
async function long_List() {
  await check_closed_SHORT_GREEN_1();
}

async function SHORT_GREEN_1() {
  try {
