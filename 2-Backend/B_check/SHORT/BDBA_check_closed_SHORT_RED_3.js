...
import { update_body_quantity_via_info_short_half_position } from "../../tools/update_body_quantity_via_info_short_half_position.js";
...
async function short_List() {
  ...
  console.log("- - - ✅ sell_short_market_body");
}

async function check_closed_SHORT_RED_3() {
  try {
...
export { check_closed_SHORT_RED_3 };
