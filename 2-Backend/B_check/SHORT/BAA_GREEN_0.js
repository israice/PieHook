...
import { check_closed_SHORT_GREEN_0 } from './BAAA_check_closed_SHORT_GREEN_0.js';
...
async function long_List() {
  await check_closed_SHORT_GREEN_0();
}


async function SHORT_GREEN_0() {
  try {
