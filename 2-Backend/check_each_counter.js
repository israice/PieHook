...
import { check_closed_trend_add_next_candle } from "./check_closed_trend_add_next_candle.js";

// === Настройки ===
const DELAY_MS = 200;  // Задержка после каждого выполнения списка в миллисекундах
...
async function for_each_in_list() {
  try {
    ...
    await check_closed_trend_add_next_candle();
    await LONG();
    await SHORT();
