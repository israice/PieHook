...
const TARGET_POSITION_SIDE = 'LONG'; // Только у этих позиций берём значение
...
async function update_body_quantity_via_info_long_half_position() {
  try {
...
export { update_body_quantity_via_info_long_half_position };
