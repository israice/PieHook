...
async function add_plus_PERCENT_GREEN_STEP_ONCE() {
  try {
    ...
    const newValue = `${(current + step).toFixed(3)}%`;

    // 2) заменяем строку с CONFIG_KEY
...
export { add_plus_PERCENT_GREEN_STEP_ONCE };
