...
### Dev Roadmap
- [ ] v.0.0.7 check for each timeframe percent and trend 
- [ ] v.0.0.6 get all other candles [0] and save in history file
...
# Github Update
git add .
git commit -m "v.0.0.5 created main runner and backend runner"
git push
