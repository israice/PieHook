// ============================================================
// УНИВЕРСАЛЬНЫЙ СКРИПТ ДЛЯ ОТПРАВКИ МАРКЕТ-ОРДЕРА sell_long_market_body
...
async function sell_long_market_body() {
  try {
    ...
    const baseOrder  = ordersData?.[CONFIG.ORDERS_YAML_KEY]?.sell_long_market_body;
    if (!baseOrder) throw new Error('❌ sell_long_market_body not found');
