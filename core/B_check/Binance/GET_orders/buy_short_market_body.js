// ============================================================
// УНИВЕРСАЛЬНЫЙ СКРИПТ ДЛЯ ОТПРАВКИ МАРКЕТ-ОРДЕРА buy_short_market_body
...
async function buy_short_market_body() {
  try {
    ...
    const baseOrder  = ordersData?.[CONFIG.ORDERS_YAML_KEY]?.buy_short_market_body;
    if (!baseOrder) throw new Error('❌ buy_short_market_body not found');
