...
import { change_STATUS_GREEN_2 } from './change_STATUS_GREEN_2.js';
...
// Suffixes for keys
const CURRENT_LOW_SUFFIX = '_high';
const OLD_LOW_SUFFIX = '_high_2';
...
async function the_List() {
  await change_STATUS_GREEN_2();
  console.log("- - - 🔵 SHORT BUY on HIGH");
}

// === MAIN FUNCTION ===
async function check_if_price_bigger_then_second_high() {
  try {
...
export { check_if_price_bigger_then_second_high };
